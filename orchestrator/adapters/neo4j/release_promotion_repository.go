...
func (r *ReleasePromotionRepository) PromoteRelease(
	...
	for _, n := range nodes {
		...
		payload = append(payload, map[string]interface{}{
			...
			"dbt_unique_id":                         n.DBTUniqueID,
			"runtime_manifest_uri":                  n.RuntimeManifestURI,
			"runtime_manifest_sha256":               n.RuntimeManifestSHA256,
			"runtime_manifest_dbt_version":          n.RuntimeManifestDBTVersion,
			"runtime_manifest_parse_context_sha256": n.RuntimeManifestParseContextSHA256,
		})
	...
	if len(nodes) > 0 {
		...
		upsertRes, err := tx.Run(ctx, `
			...
			SET existing.schema_name  = t.schema_name,
			    ...
			    existing.dbt_unique_id = t.dbt_unique_id,
			    existing.runtime_manifest_uri = t.runtime_manifest_uri,
			    existing.runtime_manifest_sha256 = t.runtime_manifest_sha256,
			    existing.runtime_manifest_dbt_version = t.runtime_manifest_dbt_version,
			    existing.runtime_manifest_parse_context_sha256 = t.runtime_manifest_parse_context_sha256,
