...
e2e-full:  ## Complete E2E test from a running docker-compose env (up -d + start-services + test + cleanup)
	...
	@docker wait continuo-flyway-state-1 continuo-flyway-startup-1 continuo-flyway-executor-1 continuo-flyway-orchestrator-1 continuo-flyway-k8s-1 2>/dev/null || true
