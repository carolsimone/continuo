...
// contract. The validation pod (the external continuo-validation-runners image,
// core/continuo_validation_core/result.py) prints the result block framed by these
