...
func PkgConstantsForTest() map[string]string {
	return map[string]string{
		...
		"ReleaseSeedsPendingV1": ReleaseSeedsPendingV1,
		...
		"StateReleaseSeedsPending": StateReleaseSeedsPending,
		...
		"ExecutorPipelineRunFinished": ExecutorPipelineRunFinished,
		"RemediationRetryRequested": RemediationRetryRequested,
