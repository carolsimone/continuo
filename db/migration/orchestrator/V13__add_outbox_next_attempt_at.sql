...
-- covered by idx_orchestrator_outbox_pending (created_at, WHERE
...
ALTER TABLE orchestrator_outbox ALTER COLUMN max_retries SET DEFAULT 10;
...
ALTER TABLE orchestrator_outbox
    DROP CONSTRAINT IF EXISTS orchestrator_outbox_status_check;
ALTER TABLE orchestrator_outbox
    ADD CONSTRAINT orchestrator_outbox_status_check
