...
ALTER TABLE remediation_outbox
...
-- covered by idx_remediation_outbox_pending (created_at, WHERE
...
ALTER TABLE remediation_outbox ALTER COLUMN max_retries SET DEFAULT 13;
...
ALTER TABLE remediation_outbox
    DROP CONSTRAINT IF EXISTS remediation_outbox_status_check;
ALTER TABLE remediation_outbox
    ADD CONSTRAINT remediation_outbox_status_check
