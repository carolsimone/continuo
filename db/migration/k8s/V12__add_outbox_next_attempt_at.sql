...
-- covered by idx_k8s_outbox_pending (created_at, WHERE status='pending')
...
ALTER TABLE k8s_outbox ALTER COLUMN max_retries SET DEFAULT 13;
...
ALTER TABLE k8s_outbox
    DROP CONSTRAINT IF EXISTS k8s_outbox_status_check;
ALTER TABLE k8s_outbox
    ADD CONSTRAINT k8s_outbox_status_check
