...
If you cannot use that form, email simone@continuo-data.com instead. Include enough detail to
...
| Stage | Target |
| --- | --- |
| Acknowledgement and initial severity assessment | Within 24 hours |
| Fix or documented mitigation | Depends on severity — P1 (critical) within 48 hours; lower severities are given a target in the assessment |
