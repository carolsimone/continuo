...
import { getDriftState, getDriftBadge } from '../../src/client/drift-helpers';
...
describe('getDriftBadge', () => {
  it('renders stale label with delta', () => {
    expect(getDriftBadge('stale', 5, 8)).toBe('source 3 gen behind latest');
  });
