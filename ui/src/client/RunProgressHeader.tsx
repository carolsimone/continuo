...
// Status buckets a run's tasks fall into. Any status not in this closed set
...
const BUCKETS = ['succeeded', 'running', 'failed', 'skipped', 'pending'] as const;
...
export default function RunProgressHeader({ tasks }: { tasks: Task[] }) {
  const counts: Record<Bucket, number> = { succeeded: 0, running: 0, failed: 0, skipped: 0, pending: 0 };
