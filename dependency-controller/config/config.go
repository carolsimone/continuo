...
func GetRedisConsumerStream() string {
	return getEnv("REDIS_CONSUMER_STREAM", "update.table:v1")
}

func GetRedisConsumerGroup() string {
	return getEnv("REDIS_CONSUMER_GROUP", "dependency_controller_consumers")
}
...
func GetGraphServiceGRPCAddr() string {
	return getEnv("GRAPH_SERVICE_GRPC_ADDR", "localhost:50052")
}

// HTTP configuration
func GetHTTPPort() int {
	return getEnvAsInt("HTTP_PORT", 8086)
}
