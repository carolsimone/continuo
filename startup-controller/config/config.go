...
func Load() Config {
	return Config{
		...
		RedisConsumerStream: env("REDIS_CONSUMER_STREAM", "scheduler.started:v1"),
		RedisConsumerGroup:  env("REDIS_CONSUMER_GROUP", "startup_controller_consumers"),
		RedisProducerStream: env("REDIS_PRODUCER_STREAM", "query.model:v1"),

		StateGRPCAddr: env("STATE_SERVICE_GRPC_ADDR", "localhost:50051"),
		GraphGRPCAddr: env("GRAPH_SERVICE_GRPC_ADDR", "graph:50052"),
