...
docker pull ghcr.io/carolsimone/continuo-python-runtime-postgres:v0.4.1 \
...
kind_load_pulled_image ghcr.io/carolsimone/continuo-python-runtime-postgres:v0.4.1 continuo || exit 1
