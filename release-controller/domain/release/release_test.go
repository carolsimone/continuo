...
func TestRelease_NewIsReceived(t *testing.T) {
	r := release.New("sha-abc", "svc1", "sha-abc", false, false, "acme/demo", "deadbeef", time.Unix(0, 0))
...
func TestRelease_TransitionReceivedToParsing(t *testing.T) {
	r := release.New("sha-abc", "svc", "tag", false, false, "acme/demo", "deadbeef", time.Unix(0, 0))
...
func TestRelease_SetAssembledImageTags(t *testing.T) {
	r := release.New("sha-abc", "svc-a", "tag-a", false, false, "acme/demo", "deadbeef", time.Unix(0, 0))
...
func TestRecordValidationResults_RetainedAcrossReject(t *testing.T) {
	r := release.New("rX", "svc", "t", false, false, "acme/demo", "deadbeef", time.Unix(1, 0).UTC())
...
func TestRecordValidationResults_RetainedAcrossPromote(t *testing.T) {
	r := release.New("rY", "svc", "t", false, false, "acme/demo", "deadbeef", time.Unix(1, 0).UTC())
	require.NoError(t, r.TransitionToParsing(time.Unix(2, 0).UTC()))
	require.NoError(t, r.TransitionToValidating(release.Topology{{UniqueID: "a"}}, []string{"a"}, time.Unix(3, 0).UTC()))
...
func TestRelease_NewCarriesProvenance(t *testing.T) {
	r := release.New("sha-abc", "svc1", "sha-abc", false, false, "acme/demo", "deadbeefcafe", time.Unix(0, 0))
...
func newReceivedRelease(t *testing.T) *release.Release {
	t.Helper()
	return release.New("sha-abc", "svc", "tag", false, false, "acme/demo", "deadbeef", time.Unix(0, 0))
}
