...
| `rerun.ready:v1` | `orchestrator` | `startup-controller` | Rerun scope resolved; payload carries `service_name` (current graph value, used for both K8s dispatch and task lookup in state) |
