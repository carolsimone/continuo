...
run.fail_reason not in {compile_failed, seed_build_failed, validation_failed,
    duplicate_table} and not (a parse reason whose contract kind is healable —
    invalid_sql, unqualified_reference) → 409 not_healable
