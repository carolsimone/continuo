...
type ScheduleCatalogRepository interface {
	...
	LoadCatalogForUpdate(ctx context.Context, tx *sqlx.Tx) (*catalog.ScheduleCatalog, error)
	SaveCatalog(ctx context.Context, tx *sqlx.Tx, c *catalog.ScheduleCatalog) error
