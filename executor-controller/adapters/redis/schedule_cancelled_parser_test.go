...
func TestParseScheduleCancelled_HappyPath(t *testing.T) {
	id := uuid.New()
	msg := goredis.XMessage{ID: "3-0", Values: map[string]interface{}{
...
func TestParseScheduleCancelled_MissingScheduleID(t *testing.T) {
	_, err := ParseScheduleCancelled(goredis.XMessage{ID: "3-0", Values: map[string]interface{}{}})
	require.Error(t, err)
}

func TestParseScheduleCancelled_InvalidScheduleID(t *testing.T) {
	_, err := ParseScheduleCancelled(goredis.XMessage{ID: "3-0", Values: map[string]interface{}{
